...
call java -cp * tool.pdf.Merge SttLfrontpages.pdf SubtitlePsalms.pdf blankpage.pdf %psalms% blankpage.pdf SubtitleHymn.pdf ..\..\Hymns\Hymn*.pdf FormsandConfessions.pdf SttLbackpages1.pdf ..\..\Hymns\Guitar.pdf SttLbackpages2.pdf
