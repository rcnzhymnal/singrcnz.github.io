...
pause
java tool.pdf.Merge SttLfrontpages.pdf SubtitlePsalms.pdf blankpage.pdf %ranges% blankpage.pdf SubtitleHymn.pdf Hymn*.pdf SttLbackpages1.pdf Guitar.pdf SttLbackpages2.pdf
java tool.pdf.Compress SttLfrontpages-m.pdf
pause
